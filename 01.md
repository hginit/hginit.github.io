...
Having solved all the little ?’s and !’s, I can go ahead and check in my changes:
    ...
    <pre><samp>
<span class="prompt">c:\hginit\CountDown> </span>hg commit</kbd>

<span class="prompt">c:\hginit\CountDown> </span>hg log</kbd>
...
<pre><samp>
<span class="prompt">c:\hginit\CountDown> </span>hg cat a.txt</kbd>
SCOTT ADAMS: Civilians believe that if it isn't
broken, don't fix it. Engineers believe that if it
isn't broken, it doesn't have enough features yet.
</samp></pre>
...
<pre><samp>
<span class="prompt">c:\hginit\CountDown> </span>hg cat -r 0 a.txt</kbd>
Scott Adams: Normal people believe that if it ain't
broke, don't fix it. Engineers believe that if it
ain't broke, it doesn't have enough features yet.
</samp></pre>
...
<pre><samp>
<span class="prompt">c:\hginit\CountDown> </span>hg diff -r 0:1 a.txt</kbd>
...
What is possible is going _back_ to any version. Watch:
  ...
  <pre><samp>
<span class="prompt">c:\hginit\CountDown> </span>hg update -r 0</kbd>
...
<span class="prompt">c:\hginit\CountDown> </span>hg up -r 1</kbd>
...
<span class="prompt">c:\hginit\CountDown> </span>hg up</kbd>
2 files updated, 0 files merged, 1 files removed, 0 files unresolved
