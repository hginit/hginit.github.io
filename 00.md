...
<img src="i/00-tokyo.png" style="float:right; margin-left: 1em; margin-bottom: 1em; border: 1px solid black;" />
...
strong> is just like <strong>svn up</strong>, without really knowing what <strong>hg fetch</strong> does, and one day, things will go wrong and you'll blame Mercurial, when you really should be blaming yourself for not understanding how Mercurial works.</p>
